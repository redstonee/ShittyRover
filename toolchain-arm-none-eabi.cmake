...
set(OBJECT_GEN_FLAGS "-O0 -mthumb -fno-builtin -Wall -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -mtune=${CPU_TYPE} -mcpu=${CPU_TYPE} -mfpu=${FPU_TYPE} -mfloat-abi=${FLOAT-ABI}" CACHE INTERNAL "Object generation options")
...
set(CMAKE_EXE_LINKER_FLAGS "-Wl,--gc-sections --specs=nano.specs --specs=nosys.specs -u _printf_float -mabi=aapcs -Wl,-Map=\"${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.map\" -mcpu=${CPU_TYPE} -mfpu=${FPU_TYPE} -mfloat-abi=${FLOAT-ABI} -mthumb -lm -lc -n" CACHE INTERNAL "Linker options")
